...
export const metadata: Metadata = {
  ...
  description: 'Living Models — adaptive learning platform, white-label, institution-deployable AI education infrastructure.',
}
    ...
    <div className="container px-4 md:px-6 mx-auto py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          <section>
            <p>
              Living Models is an adaptive learning platform built for institutions. We provide white-label,
          ...
          <section>
            ...
            <p>
              Living Models was founded by <strong>Nik Bear Brown</strong> and <strong>Srinivas Sridhar</strong>.
          ...
          <section>
            ...
            <p>
              ...
              from universities to workforce training programs. Living Models provides the AI backbone so
          ...
          <section>
            ...
            <p>
              Living Models develops AI-powered tools for education — adaptive assessments, personalized
          ...
          <section>
            ...
            <p>
              Interested in deploying Living Models at your institution? Reach out at{' '}
            ...
            <div className="flex flex-wrap gap-4 mt-4 not-prose">
              <a href="https://github.com/LivingModels" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://youtube.com/playlist?list=PLIS8mRE04Mvoif0tBUlgNV52euT9E5q_e&si=jON2rhrasmimGth8" target="_blank" rel="noopener noreferrer"
                className="inline-flex h-10 items-center justify-center rounded-md px-8 text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring bg-black text-white shadow hover:bg-gray-800 dark:border dark:border-input dark:bg-background dark:text-foreground dark:shadow-sm dark:hover:bg-accent dark:hover:text-accent-foreground">
                YouTube
              </a>
            </div>
