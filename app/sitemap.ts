...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://livingmodels.org'
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const entries: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/livingmodels`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
